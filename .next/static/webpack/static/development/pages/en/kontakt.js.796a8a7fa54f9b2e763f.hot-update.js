    ...
    if (isDateAnswerOneChecked === true || isDateAnswerTwoChecked === true) {
      ...
      if (e.currentTarget.classList.contains('goFirst')) {
        ...
        if (secondStepLock.current.nextElementSibling.value.length > 0) {
          secondStepLock.current.parentElement.classList.contains('uncheckedField') === true ? secondStepLock.current.parentElement.classList.remove('uncheckedField') : null;
          formSteps.current.classList.remove('atSecondStep');
...
//# sourceMappingURL=kontakt.js.796a8a7fa54f9b2e763f.hot-update.js.map