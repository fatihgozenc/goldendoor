...
module.exports = __webpack_require__("aqNn");
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("Ej9T");
...
/* harmony import */ var _components_templates_leistungen__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("7BxD");
...
const LeistungenPage = ({
  data
}) => __jsx(_components_templates_leistungen__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"], {
  data: data
});

LeistungenPage.getInitialProps = async () => {
  const res = await fetch(`${_config__WEBPACK_IMPORTED_MODULE_1__[/* API_HOST */ "a"]}de/services`);
