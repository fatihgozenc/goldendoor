...
module.exports = __webpack_require__("cSl8");
...
/* harmony import */ var _MehrLesen__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("9Ksj");
/* harmony import */ var _slider_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("uhl+");
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__("nv6v");
...
/* harmony default export */ __webpack_exports__["a"] = (function ({
  ...
  }, __jsx("h3", null, data.title), __jsx("p", null, html_react_parser__WEBPACK_IMPORTED_MODULE_2___default()(data.content.replace(/\n/g, "<br />"))), __jsx("div", {
  ...
  }, "LOCATION:"), __jsx(_MehrLesen__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"], {
  ...
  }, data.fields.referenz_slider.map((item, imageKey) => __jsx(pure_react_carousel__WEBPACK_IMPORTED_MODULE_3__["Slide"], {
    key: imageKey,
    index: imageKey
  }, __jsx("img", {
    width: "100%",
...
ReferenzPage.getInitialProps = async context => {
  ...
  const res = await fetch(`${_config__WEBPACK_IMPORTED_MODULE_1__[/* API_HOST */ "a"]}de/references/${id}`);
