...
module.exports = __webpack_require__("XGbj");
...
KarrierePage.getInitialProps = async () => {
  const res = await fetch(`${_config__WEBPACK_IMPORTED_MODULE_1__[/* API_HOST */ "a"]}de/career`);
...
/* harmony default export */ var karriere = __webpack_exports__["a"] = (({
  ...
  return karriere_jsx(external_react_default.a.Fragment, null, karriere_jsx(external_next_seo_["NextSeo"], {
