...
module.exports = __webpack_require__("kLRv");
...
GaleriePage.getInitialProps = async () => {
  const res = await fetch(`${_config__WEBPACK_IMPORTED_MODULE_1__[/* API_HOST */ "a"]}en/gallery`);
...
/* harmony default export */ var galerie = __webpack_exports__["a"] = (function ({
  ...
  return galerie_jsx(external_react_default.a.Fragment, null, galerie_jsx(external_next_seo_["NextSeo"], {
