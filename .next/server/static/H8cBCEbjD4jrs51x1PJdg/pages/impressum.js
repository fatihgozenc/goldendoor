...
/* harmony import */ var _components_templates_impressum__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("aDM4");
...
const ImpressumPage = ({
  data
}) => __jsx(_components_templates_impressum__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"], {
  data: data
});

ImpressumPage.getInitialProps = async () => {
  const res = await fetch(`${_config__WEBPACK_IMPORTED_MODULE_1__[/* API_HOST */ "a"]}de/impressum`);
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("6Erl");
