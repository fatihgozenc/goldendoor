...
/* harmony import */ var _loopingGallery__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../loopingGallery */ "./components/loopingGallery/index.js");
/* harmony import */ var _Icon__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../Icon */ "./components/Icon.js");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./style.scss */ "./components/templates/galerie/style.scss");
...
/* harmony default export */ __webpack_exports__["default"] = (function ({
  ...
  return __jsx("div", {
    ...
    __self: this
  }, __jsx(_loopingGallery__WEBPACK_IMPORTED_MODULE_4__["default"], {
    data: items,
    windowWidth: windowWidth,
    windowHeight: windowHeight,
    __source: {
    ...
    __self: this
  }, items.map((item, key) => __jsx(pure_react_carousel__WEBPACK_IMPORTED_MODULE_2__["Slide"], {
    slideindex: key,
    ...
    __self: this
  }, item.info.veranstaltungsart)), html_react_parser__WEBPACK_IMPORTED_MODULE_3___default()(item.inhalt)))), __jsx(pure_react_carousel__WEBPACK_IMPORTED_MODULE_2__["ButtonBack"], {
    ...
    __self: this
  }), __jsx(pure_react_carousel__WEBPACK_IMPORTED_MODULE_2__["DotGroup"], {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 67
    },
...
const GaleriePage = ({
  data
}) => __jsx(_components_templates_galerie__WEBPACK_IMPORTED_MODULE_2__["default"], {
  data: data,
  __source: {
    fileName: _jsxFileName,
    lineNumber: 4
...
GaleriePage.getInitialProps = async () => {
  const res = await fetch(`${_config__WEBPACK_IMPORTED_MODULE_1__["API_HOST"]}de/gallery`);
...
/***/ 5:
/*!********************************!*\
  !*** multi ./pages/galerie.js ***!
  \********************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Users/macbook/repos/goldendoor-next/pages/galerie.js */"./pages/galerie.js");
