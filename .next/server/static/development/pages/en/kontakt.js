...
var _jsxFileName = "/Users/fatih/repos/goldendoor-next/components/templates/kontakt/index.js";
...
var _jsxFileName = "/Users/fatih/repos/goldendoor-next/pages/en/kontakt.js";
...
KontaktPage.getInitialProps = async () => {
  const lang = 'en';
  const res = await fetch(`${"http://goldendoor-api.narcissundtaurus.com/wp-json/gd/"}en/contact`);
  const layoutRes = await fetch(`${"http://goldendoor-api.narcissundtaurus.com/wp-json/gd/"}en/layout`);
